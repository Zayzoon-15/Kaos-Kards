...
enemyInfo = {
    ...
    //Main Crew
    dog : new enemyCreate("Dog the Duck",sDog,.3,.3,enemyCreateAnims(),[actionCards.heal,actionCards.heal,actionCards.heal,actionCards.shield,actionCards.shield,actionCards.bread,actionCards.bread,actionCards.bread,actionCards.slash,actionCards.slash],[kaosCards.swoop],new enemyCreateStrat(30,60,20,70,70,2,80,0)),
    
    angel : new enemyCreate("Angel the Juvenile",sAngel,.5,.5,enemyCreateAnims(),[actionCards.heal,actionCards.heal,actionCards.heal,actionCards.shield,actionCards.shield,actionCards.flamingAce,actionCards.flamingAce,actionCards.flamingAce,actionCards.laser,actionCards.laser],[kaosCards.high],new enemyCreateStrat(40,60,20,60,80,2,90,0)),
    
    cock : new enemyCreate("Cock the Bug",sCock,.6,.4,enemyCreateAnims(),[actionCards.heal,actionCards.heal,actionCards.heal,actionCards.shield,actionCards.shield,actionCards.poison,actionCards.poison,actionCards.poison,actionCards.bread,actionCards.bread],[kaosCards.destroy],new enemyCreateStrat(60,70,50,75,70,2,80,0)),
	
    alien : new enemyCreate("Alan the Alien",sAlien,.7,.8,enemyCreateAnims(),[actionCards.heal,actionCards.heal,actionCards.heal,actionCards.shield,actionCards.shield,actionCards.laser,actionCards.laser,actionCards.laser,actionCards.bread,actionCards.bread],[kaosCards.swap,kaosCards.freeze],new enemyCreateStrat(70,60,40,70,75,2,90,0)),
    ...
    //Spooky Crew
    bones : new enemyCreate("Jones the Living Bones",sBones,2,4,enemyCreateAnims(),[actionCards.heal,actionCards.heal,actionCards.shield,actionCards.shield,actionCards.slash,actionCards.slash,actionCards.flamingAce,actionCards.flamingAce,actionCards.flamingAce],[kaosCards.hotdog],new enemyCreateStrat(90,70,80,85,40,2,100,0)),
