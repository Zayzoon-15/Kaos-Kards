...
diceCards = {
    ...
    undefined,CARDTYPES.DICE,sDiceCard,diceCardReroll),
    ...
    undefined,CARDTYPES.DICE,sDiceCard,diceCardSwapDice,0,diceTypes.dice8),
    
    dice12 : new createCard("12 Sided Dice",
    "Changes one random dice to a 12 sided dice\nCan only be placed before roll",
    undefined,CARDTYPES.DICE,sDiceCard,diceCardSwapDice,0,diceTypes.dice12),
    
    dice20 : new createCard("20 Sided Dice",
    "Changes one random dice to a 20 sided dice\nCan only be placed before roll",
    undefined,CARDTYPES.DICE,sDiceCard,diceCardSwapDice,0,diceTypes.dice20),
