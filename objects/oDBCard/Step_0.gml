...
if grabbed
{
    ...
    if hover
    {
        ...
        if onMouse <= 4 and onMouse > 0
        {
            ...
            TweenFire(self,EaseOutBack,TWEEN_MODE_ONCE,true,0,1,"cardAngle",_start,_end);
        }
        onMouse = 0;
    ...
    //Position
    x = lerp_dt(x,targetX+cardXOffset,.3);
    y = lerp_dt(y,targetY+cardYOffset,.3);
    cardX = x;
