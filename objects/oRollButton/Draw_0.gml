...
if canRoll
{
    draw_sprite_ext(sprite_index, image_index, x+_shakeX, y+shadowY+_shakeY, image_xscale-shadowSize, image_yscale-shadowSize, image_angle, c_black, .7*image_alpha);
}
...
draw_text_transformed(x,y,"Roll",textScale,textScale,0);
