...
//Draw The Box
drawRectOutlined(x-_halfWidth-widthMargin,y-height-(heightMargin*2),x+_halfWidth+widthMargin,y,_rectRound,c_black,c_white,UIBOX_ALPHA*textAlpha,1*textAlpha);
